...
- **Log entry** — append to a same-day log for the same work (see Global Rule 5), or create `.docs/logs/YYYY-MM-DD-kebab-task-name.md` if none exists. Captures what was done, key decisions made, and why
