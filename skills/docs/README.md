...
- Roadmap docs created by **`research`** are implementation inputs. Build from them using your normal delivery workflow, then use **`sync`** or repo policy to capture shipped changes back into `.docs/`.
